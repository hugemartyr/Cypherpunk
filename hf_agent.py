...
# # AGENT_MAILBOX_BEARER_TOKEN= os.getenv("AGENTVERSE_API_KEY")
# # print(f"[DEBUG] AGENTVERSE_API_KEY: {AGENT_MAILBOX_BEARER_TOKEN}")
...
# # Agent Configuration
# AGENT_SEED = os.getenv("HF_MANAGER_SEED", "hf_manager_agent_secret_seed_phrase_abc_dhwwdws")
...
# This is an HF Agent that manages Hugging Face models.
# - **Address:** `{agent_address}`
...
# async def startup_handler_(ctx: Context):
...
AGENT_MAILBOX_BEARER_TOKEN="eyJhbGciOiJSUzI1NiJ9.eyJleHAiOjE3NjQ4Njg3NDYsImlhdCI6MTc2MjI3Njc0NiwiaXNzIjoiZmV0Y2guYWkiLCJqdGkiOiJiOGJmNmQzMjc3MjlkNDk3N2UyZjMzNjYiLCJzY29wZSI6ImF2Iiwic3ViIjoiNzJkZmZhODAyOGVhNmZjZjE5ZmY1MDFiYTU0MTU0MzNiYTJhZTc2MTRiNGE1ZDk3In0.nR4Dfm9-byaeAKfyHggSrMl9IOac7gNKgOWWi3kFuN2aKrRZAzglDknB-XPdLQM2KegDxXd3ZTTE5QVblMp1szzwGis3ujJBQQGkGxfjvorlqCFEKHT6-Dskb6CuJyD35PcrdKJnrLDYUtJCOCUscJiqEcSpmovy0dCsbRzYyMBBWhr67rmzgaLMA3iA2kYBLTDKOPrxul_1K532u5VhNde6jiEiggAnASmpqLKKwE0-UKvunIAWrcImII62tBNPo7CvDVV4DyQ1_DgMgECCeA98i1RSaCzShGkxJJxzRIEgoWSXQdwHsv6JRzOzx8pjT3CCGr28vfhXkLIskOwPRQ"
# ASI:One API Configuration
API_KEY = os.getenv("ASI_ONE_API_KEY")
BASE_URL = "https://api.asi1.ai/v1/chat/completions"
MODEL_NAME = "asi1-mini" # Use the mini model
