...
try:
    ...
    logger.error("FATAL ERROR: Could not import runner script generators. Make sure specialist_agent_runner_script.py and transient_runner_script.py exist.")
    sys.exit(1)
...
# Dictionary to store conversation history per user session
# Key: Session ID (derived from sender address or initial message)
# Value: List of messages for ASI:One API
